 ...
 * <p>To run this file:
 *
 * <p>./gradlew run -Pmain=com.gsd.algorithms.datastructures.sparsetable.SparseTable
 *
* SE371/475 Global Software Dev - Project 1 - Unit Testing
 */
package com.gsd.algorithms.datastructures.sparsetable;
...
public class SparseTable {
  ...
  public SparseTable(long[] values, Operation op) {
    // TODO: Lazily call init in query methods instead of initializing in constructor?
    this.op = op;
    init(values);
  }
