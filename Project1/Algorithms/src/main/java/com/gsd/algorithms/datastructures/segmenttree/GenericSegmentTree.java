 ...
 */
package com.gsd.algorithms.datastructures.segmenttree;
...
public class GenericSegmentTree {
  ...
  private interface Ruf {
    ...
    // TODO: reorder to be base, delta, tl, tr
  ...
  // TODO: Document the justification for each function below
  ...
  // TODO: confirm this cannot be supported? Can we maintain additional
  ...
  public GenericSegmentTree(
    ...
    //
    // TODO: Investigate to reduce this space. There are only 2n-1 segments, so we should
    ...
    t = new Long[N];
    // TODO: Change this to be of size n to reduce memory from O(4n) to O(3n)
    lazy = new Long[N];
