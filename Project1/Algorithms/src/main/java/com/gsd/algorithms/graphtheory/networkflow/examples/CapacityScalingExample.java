 ...
 *
 * <p>Build: $ javac
 * src/main/java/com/gsd/algorithms/graphtheory/networkflow/examples/CapacityScalingExample.java
 *
 * <p>Run: $ java -cp src/main/java/
 * com/gsd/algorithms/graphtheory/networkflow/examples/CapacityScalingExample
 */
package com.gsd.algorithms.graphtheory.networkflow.examples;
