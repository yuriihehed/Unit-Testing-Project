 ...
 * src/main/java/com/gsd/algorithms/strings/LongestCommonSubstring.java
 *
 * <p>Run: $ java -cp src/main/java com/gsd/algorithms/strings/LongestCommonSubstring
 *
* SE371/475 Global Software Dev - Project 1 - Unit Testing
 */
package com.gsd.algorithms.strings;
...
public class LongestCommonSubstring {
  ...
  public static class LcsSolver {
    ...
    // TODO: support LCS with strings as int arrays for larger alphabet sizes.
    ...
    private boolean enoughUniqueColorsInWindow(int lo, int hi) {
      // TODO: Avoid initializing a new hash set to count colors every method call.
      Set<Integer> set = new HashSet<>();
      for (int i = lo; i <= hi; i++) {
        set.add(imap[sa[i]]);
      }
      // TODO: Investigate if == can become >=
      return set.size() == k;
    }
    ...
    private void solve() {
      ...
      // TODO: Replace with SlidingWindowMinimum for speed.
