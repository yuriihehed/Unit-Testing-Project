 ...
 * src/main/java/com/gsd/algorithms/graphtheory/networkflow/examples/FordFulkersonExample.java
 *
 * <p>Run: $ java -cp src/main/java
 * com/gsd/algorithms/graphtheory/networkflow/examples/FordFulkersonExample
 */
